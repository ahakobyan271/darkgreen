...
$.getJSON('data.json', function (data) {
  ...
  function showcart() {
    ...
    var out = ''
    for (var key in cart) {
      out += '<div class="cell" data-id=' + data[key]['id'] + ' data-price="' + data[key]['weight'] * 3 + '" >';
      out += '<img    class="detail img "  src="' + data[key]['photo'] + '"   >';
      out += '<p class="price"> ' + data[key]['material'] + '</p>'
      out += '<p class="price">$' + data[key]['weight'] * 3 + '</p>'
      out += '<p class="addtocanvasBtn" data-id=' + data[key]['id'] + ' data-price="' + data[key]['weight'] * 3 + '">Add to canvas</p>'
